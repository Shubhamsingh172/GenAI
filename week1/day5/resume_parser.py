...
# print(raw_json)
'''
output : just seeing what is the ouptut 
 "education_requirements": [
      "Bachelor’s degree in Computer Science, Computer Engineering, Data Science, Information Systems, or related STEM fields"
   ],
   "responsibilities": [
...
'''
None
['Bachelor’s degree in Computer Science, Computer Engineering, DataScience, Information Systems, or related STEM fields']
'''

#parsing yaha se kar rahe hai 
